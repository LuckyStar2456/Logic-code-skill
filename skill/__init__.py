...
def transcribe_code(code: str, context: dict = None) -> Dict[str, Any]:
    """
    Transcribe code to logical natural language description.
    ...
    try:
        ...
        for func in functions:
            ...
            if func_code:
                ...
                natural_lang_parts.append(func_transcription)
        ...
        if not functions:
            natural_lang_parts.append(transcribe_standalone_code(code, detected_lang))
